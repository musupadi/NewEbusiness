...
public class SpinnerDivisi extends ArrayAdapter<DataModel> {
    public SpinnerDivisi(Context context, List<DataModel> list) {
    ...
    private View initView(int position, View convertView, ViewGroup parent) {
        ...
        if (currentItem != null) {
            textSpinner.setText(currentItem.getNama_divisi_mandiri());
            textId.setText(currentItem.getId_divisi_mandiri());
        }
        return convertView;
    }
}
