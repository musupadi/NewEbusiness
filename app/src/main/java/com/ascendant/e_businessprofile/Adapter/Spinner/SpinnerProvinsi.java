...
public class SpinnerProvinsi extends ArrayAdapter<DataModel> {
    public SpinnerProvinsi(Context context, List<DataModel> list) {
    ...
    private View initView(int position, View convertView, ViewGroup parent) {
        ...
        if (currentItem != null) {
            textSpinner.setText(currentItem.getNama_provinsi());
