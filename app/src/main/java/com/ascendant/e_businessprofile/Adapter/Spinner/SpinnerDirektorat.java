...
public class SpinnerDirektorat extends ArrayAdapter<DataModel> {
    public SpinnerDirektorat(Context context, List<DataModel> list) {
    ...
    private View initView(int position, View convertView, ViewGroup parent) {
        ...
        if (currentItem != null) {
            textSpinner.setText(currentItem.getNama_direktorat());
            textId.setText(currentItem.getId_direktorat());
        }
        return convertView;
    }
}
