...
public class SpinnerKota extends ArrayAdapter<DataModel> {
    public SpinnerKota(Context context, List<DataModel> list) {
    ...
    private View initView(int position, View convertView, ViewGroup parent) {
        ...
        if (currentItem != null) {
            textSpinner.setText(currentItem.getNama_kab_kota());
