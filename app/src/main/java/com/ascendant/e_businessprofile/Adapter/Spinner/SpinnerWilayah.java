...
public class SpinnerWilayah extends ArrayAdapter<DataModel> {
    public SpinnerWilayah(Context context, List<DataModel> list) {
    ...
    private View initView(int position, View convertView, ViewGroup parent) {
        ...
        if (currentItem != null) {
            textSpinner.setText(currentItem.getNama_wilayah_mandiri());
            textId.setText(currentItem.getId_wilayah_mandiri());
        }
        return convertView;
    }
}
