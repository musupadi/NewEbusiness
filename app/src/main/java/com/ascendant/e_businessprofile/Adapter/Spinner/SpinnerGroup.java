...
public class SpinnerGroup extends ArrayAdapter<DataModel> {
    public SpinnerGroup(Context context, List<DataModel> list) {
    ...
    private View initView(int position, View convertView, ViewGroup parent) {
        ...
        if (currentItem != null) {
            textSpinner.setText(currentItem.getNama_group_pusat());
            textId.setText(currentItem.getId_group_pusat());
        }
        return convertView;
    }
}
