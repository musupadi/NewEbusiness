...
public class DERActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_deractivity);
    ...
    private void Hitung() {
        ...
        hasil.setText("Perusahaan mengunakan pendanaan utang sebesar " + String.valueOf(df2.format(Hasil)) + " Persen dibandingkan dengan pendanaan ekuitas");
    }
}