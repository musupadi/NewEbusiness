...
import com.ascendant.e_businessprofile.Adapter.AdapterHospitalEquipment;
...
public class HospitalEquipmentFragment extends Fragment {
    ...
    public HospitalEquipmentFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_hospital_equipment, container, false);
    }
    ...
    private void Logic(){
        ...
        Call<ResponseArrayObject> data =api.HealthCare_Hospital_Equipment(Token);
            ...
            public void onResponse(Call<ResponseArrayObject> call, Response<ResponseArrayObject> response) {
                try {
                    if (response.body().getKode().equals(200)){
                        ...
                        mAdapter = new AdapterHospitalEquipment(getActivity(),mItems);
