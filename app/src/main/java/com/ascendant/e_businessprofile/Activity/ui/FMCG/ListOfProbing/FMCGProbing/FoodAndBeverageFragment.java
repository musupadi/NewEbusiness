...
public class FoodAndBeverageFragment extends Fragment {
    RecyclerView rv;
    ...
    DB_Helper dbHelper;
    String Token;
    public FoodAndBeverageFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_food_and_beverage, container, false);
    }
    ...
    private void Logic(){
        ...
        Call<ResponseArrayObject> data =api.FMCG_List_of_Probing(Token,"fnb");
