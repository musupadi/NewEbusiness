...
public class DetailAssosiationActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detail_assosiation);
        Declaration();
        Intent data = getIntent();
        String ID = data.getStringExtra("ID");
        String PENGURUS = data.getStringExtra("PENGURUS");
        String ANGGOTA = data.getStringExtra("ANGGOTA");
        Bundle bundle = new Bundle();
        bundle.putString("ID", ID);
        bundle.putString("PENGURUS", PENGURUS);
        bundle.putString("ANGGOTA", ANGGOTA);
        fragment = new DetailAssosiationFragment();
