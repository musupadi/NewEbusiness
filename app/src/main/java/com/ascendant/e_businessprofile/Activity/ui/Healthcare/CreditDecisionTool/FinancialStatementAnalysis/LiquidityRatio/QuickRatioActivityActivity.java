...
public class QuickRatioActivityActivity extends AppCompatActivity {
    EditText AsetLancar,Persediaan,LiabilitasJangkaPendek;
    Button hitung;
    TextView hasil;
    CardView cardView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_quick_ratio_activity);
    ...
    private void Hitung(){
        ...
        String persediaan = Persediaan.getText().toString().replace(",","");
        String liabilitas = LiabilitasJangkaPendek.getText().toString().replace(",","");
        double Hasil = (Double.parseDouble(asetLancar.replace(".",""))-Double.parseDouble(persediaan.replace(".","")))/Double.parseDouble(liabilitas.replace(".",""));
        DecimalFormat df2 = new DecimalFormat("#.##");
        hasil.setText("Perusahaan mampu membayar liabilitas jangka pendeknya "+ String.valueOf(df2.format(Hasil)) +" Kali");
    }
}