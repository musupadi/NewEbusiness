...
import com.ascendant.e_businessprofile.Adapter.AdapterListVoting;
...
public class VotingActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            Toast.makeText(VotingActivity.this, "Anda Belum Login", Toast.LENGTH_SHORT).show();
    ...
    private void Logic(){
        ...
        data.enqueue(new Callback<ResponseArrayObject>() {
            ...
            public void onResponse(Call<ResponseArrayObject> call, Response<ResponseArrayObject> response) {
                try {
                    if (response.body().getKode().equals(200)){
                        ...
                        mAdapter = new AdapterListVoting(VotingActivity.this,mItems,rv);
                        rv.setAdapter(mAdapter);
                        mAdapter.notifyDataSetChanged();
                    }else{
                        Toast.makeText(VotingActivity.this, response.body().getMessage(), Toast.LENGTH_SHORT).show();
                    }
                }catch (Exception e){
                    Toast.makeText(VotingActivity.this, "Anda Belum Login", Toast.LENGTH_SHORT).show();
                    Intent intent = new Intent(VotingActivity.this, LoginActivity.class);
            ...
            public void onFailure(Call<ResponseArrayObject> call, Throwable t) {
                Toast.makeText(VotingActivity.this, "Koneksi Gagal", Toast.LENGTH_SHORT).show();
            }
        });
    }
}