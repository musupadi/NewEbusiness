...
public class ROEActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_roeactivity);
    ...
    private void Hitung() {
        ...
        hasil.setText("Investasi pemegang saham mampu menghasilkan " + String.valueOf(df2.format(Hasil)) + " persen profit");
    }
}