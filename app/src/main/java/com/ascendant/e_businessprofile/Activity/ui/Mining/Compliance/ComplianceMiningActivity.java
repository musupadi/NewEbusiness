...
import com.ascendant.e_businessprofile.Model.StaticModel.Mining.InternalResource.MiningInternalResourceModel;
...
public class ComplianceMiningActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pList.addAll(MiningInternalResourceModel.getListData());
