...
public class HealthcareMandiriUpdate extends AppCompatActivity {
    RecyclerView rv;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_healthcare_mandiri_update);
        ...
        if (datas != null && datas.isHierarchical()) {
            ...
            Intent goInput = new Intent(HealthcareMandiriUpdate.this, DetailMandiriUpdate.class);
            ...
            public void onResponse(Call<ResponseArrayObject> call, Response<ResponseArrayObject> response) {
                try {
                    if (response.body().getKode().equals(200)){
                        ...
                        mAdapter = new AdapterMandiriUpdate(HealthcareMandiriUpdate.this,mItems);
                        rv.setAdapter(mAdapter);
                        mAdapter.notifyDataSetChanged();
                    }else{
                        Toast.makeText(HealthcareMandiriUpdate.this, response.body().getMessage(), Toast.LENGTH_SHORT).show();
                    }
                }catch (Exception e){
                    Log.d("ZYARGA : ",e.toString());
                    Toast.makeText(HealthcareMandiriUpdate.this, "Terjadi Kesaqlahan", Toast.LENGTH_SHORT).show();
                }
            }

            @Override
            public void onFailure(Call<ResponseArrayObject> call, Throwable t) {
                Toast.makeText(HealthcareMandiriUpdate.this, "Koneksi Gagal", Toast.LENGTH_SHORT).show();
            }
        });
    }

    private void Backs(){
        Intent intent = new Intent(HealthcareMandiriUpdate.this, ModuleActivity.class);
