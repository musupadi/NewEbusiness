...
import com.ascendant.e_businessprofile.Activity.ui.Healthcare.BusinessRefrence.RegulationsFragment;
...
public class FMCGRegulationActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fmcgregulation);
        Declaration();
        Home.setImageResource(R.drawable.home_active);
        fragment = new FMCGRegulationFragment();
