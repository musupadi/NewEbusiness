...
public class InventoryTurnoverActivity extends AppCompatActivity {
    ...
    private void Hitung() {
        ...
        hasil.setText("Persediaan beputar (dijual) " + String.valueOf(df2.format(Hasil)) +  " kali selama satu tahun");
    }
}