...
public class PolutryFarmingActivity extends AppCompatActivity {
    Spinner Kategori;
    RecyclerView rv;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_polutry_farming);
            ...
            public void onResponse(Call<ResponseArrayObject> call, Response<ResponseArrayObject> response) {
                ...
                try {
                    if (response.body().getKode().equals(200)){
                        ...
                        mAdapter = new AdapterPerusahaanFarming(PolutryFarmingActivity.this,mItems);
                        rv.setAdapter(mAdapter);
                        mAdapter.notifyDataSetChanged();
                    }else{
                        Toast.makeText(PolutryFarmingActivity.this, response.body().getMessage(), Toast.LENGTH_SHORT).show();
                    }
                }catch (Exception e){
                    Log.d("ZYARGA : ",e.toString());
                    Toast.makeText(PolutryFarmingActivity.this, "Terjadi Kesaqlahan", Toast.LENGTH_SHORT).show();
                }
            }

            @Override
            public void onFailure(Call<ResponseArrayObject> call, Throwable t) {
                Toast.makeText(PolutryFarmingActivity.this, "Koneksi Gagal", Toast.LENGTH_SHORT).show();
            }
        });
    }
}