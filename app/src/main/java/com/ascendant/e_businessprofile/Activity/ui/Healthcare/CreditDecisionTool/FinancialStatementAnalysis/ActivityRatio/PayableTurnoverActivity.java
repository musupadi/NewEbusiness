...
public class PayableTurnoverActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_payable_turnover);
    ...
    private void Hitung() {
        ...
        hasil.setText("Perusahaan mampu membayarkan Utangnya rata-rata " + String.valueOf(df2.format(Hasil)) + " Kali");
    }
}