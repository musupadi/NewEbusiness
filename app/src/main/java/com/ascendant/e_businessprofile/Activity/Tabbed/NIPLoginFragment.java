...
public class NIPLoginFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_n_i_p_login, container, false);
    }
    ...
    private void Logic(){
        ...
        FirebaseMessaging.getInstance().getToken().addOnCompleteListener(new OnCompleteListener<String>() {
            ...
            public void onComplete(@NonNull Task<String> task) {
                ...
                dbHelper = new DB_Helper(getActivity());
                ApiRequest api = RetroServer.getClient().create(ApiRequest.class);
                final Call<ResponseArrayObject> data =api.login_nip(username.getText().toString(),password.getText().toString(),token);
                data.enqueue(new Callback<ResponseArrayObject>() {
                    @Override
                    public void onResponse(Call<ResponseArrayObject> call, Response<ResponseArrayObject> response) {
                        pd.hide();
