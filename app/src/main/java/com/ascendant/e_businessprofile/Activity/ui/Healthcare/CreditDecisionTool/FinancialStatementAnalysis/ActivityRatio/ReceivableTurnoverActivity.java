...
public class ReceivableTurnoverActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_receivable_turnover);
    ...
    private void Hitung() {
        ...
        hasil.setText("Piutang usaha telah berputar (menjadi kas) " + String.valueOf(df2.format(Hasil)) + " kali selama satu tahun");
    }
}