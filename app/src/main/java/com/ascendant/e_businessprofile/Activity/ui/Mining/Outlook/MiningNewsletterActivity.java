...
public class MiningNewsletterActivity extends AppCompatActivity {
    RecyclerView rv;
    ...
    private void Logic(){
        ...
        Call<ResponseArrayObject> data =api.MiningOutlook(Token,"newsletter");
        data.enqueue(new Callback<ResponseArrayObject>() {
            ...
            public void onResponse(Call<ResponseArrayObject> call, Response<ResponseArrayObject> response) {
                try {
                    if (response.body().getKode().equals(200)){
                        ...
                        mAdapter = new AdapterOutlook(MiningNewsletterActivity.this,mItems);
            ...
            public void onFailure(Call<ResponseArrayObject> call, Throwable t) {
                Toast.makeText(MiningNewsletterActivity.this, "Koneksi Gagal", Toast.LENGTH_SHORT).show();
            }
        });
    }
}