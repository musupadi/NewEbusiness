package com.ascendant.e_businessprofile.Activity.ui.Healthcare.CreditWorthiness.HospitalKeyOfSucces;
...
public class HospitalKeyOfSuccessActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hospital_key_of_success);
    ...
    private void Logic(){
        mManager = new LinearLayoutManager(HospitalKeyOfSuccessActivity.this, LinearLayoutManager.VERTICAL,false);
        recyclerView.setLayoutManager(mManager);
        ApiRequest api = RetroServer.getClient().create(ApiRequest.class);
        Call<ResponseArrayObject> data =api.HealthCare_Key_Of_Success(Token);
        data.enqueue(new Callback<ResponseArrayObject>() {
            ...
            public void onResponse(Call<ResponseArrayObject> call, Response<ResponseArrayObject> response) {
                try {
                    if (response.body().getKode().equals(200)){
                        ...
                        mAdapter = new AdapterKeyOfSuccess(HospitalKeyOfSuccessActivity.this,mItems);
            ...
            public void onFailure(Call<ResponseArrayObject> call, Throwable t) {
                Toast.makeText(HospitalKeyOfSuccessActivity.this, "Koneksi Gagal", Toast.LENGTH_SHORT).show();
            }
        });
    }
}