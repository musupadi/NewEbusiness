...
import com.ascendant.e_businessprofile.Model.StaticModel.Contractor.InternalResource.ContractorInternalResource;
...
public class ComplianceContractorActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pList.addAll(ContractorInternalResource.getListData());
            ...
            public void onResponse(Call<ResponseArrayObject> call, Response<ResponseArrayObject> response) {
                try {
                    if (response.body().getKode().equals(200)){
                        ...
                        Toast.makeText(ComplianceContractorActivity.this, "Anda Belum Login", Toast.LENGTH_SHORT).show();
                        Intent intent = new Intent(ComplianceContractorActivity.this, LoginActivity.class);
